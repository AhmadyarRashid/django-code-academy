# Generated by Django 4.0.5 on 2023-03-18 05:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeState', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tourist_attractions_form.state', verbose_name='Home State')),
            ],
        ),
    ]
